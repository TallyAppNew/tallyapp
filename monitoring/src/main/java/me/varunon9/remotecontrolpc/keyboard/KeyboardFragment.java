...
public class KeyboardFragment extends Fragment implements View.OnTouchListener, View.OnClickListener, TextWatcher {
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        int id = v.getId();
        if (id == R.id.ctrlButton) {
            keyCode = 17;
        } else if (id == R.id.altButton) {
            keyCode = 18;
        } else if (id == R.id.shiftButton) {
            keyCode = 16;
        }
    ...
    public void onClick(View v) {
        ...
        if (id == me.varunon9.remotecontrolpc.R.id.clearTextButton) {
            ...
            if (id == R.id.ctrlAltTButton) {
                message = "CTRL_ALT_T";
            } else if (id == R.id.ctrlShiftZButton) {
                message = "CTRL_SHIFT_Z";
            } else if (id == R.id.altF4Button) {
                message = "ALT_F4";
            }
            ...
            if (id == R.id.enterButton) {
                ...
                keyCode = 9;
            } else if (id == R.id.escButton) {
                keyCode = 27;
            } else if (id == R.id.printScrButton) {
                keyCode = 154;
            } else if (id == R.id.deleteButton) {
                keyCode = 127;
            } else if (id == R.id.nButton) {
                keyCode = 78;
            } else if (id == R.id.tButton) {
                keyCode = 84;
            } else if (id == R.id.wButton) {
                keyCode = 87;
            } else if (id == R.id.rButton) {
                keyCode = 82;
            } else if (id == R.id.fButton) {
                keyCode = 70;
            } else if (id == R.id.zButton) {
                keyCode = 90;
            } else if (id == R.id.cButton) {
                keyCode = 67;
            } else if (id == R.id.xButton) {
                keyCode = 88;
            } else if (id == R.id.vButton) {
                keyCode = 86;
            } else if (id == R.id.aButton) {
                keyCode = 65;
            } else if (id == R.id.oButton) {
                keyCode = 79;
            } else if (id == R.id.sButton) {
                keyCode = 83;
